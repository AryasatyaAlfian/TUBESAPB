              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _statItem('Hadir', selectedData['hadir'], Colors.green),
                      _statItem('Izin', selectedData['izin'], Colors.blue),
                      _statItem('Sakit', selectedData['sakit'], Colors.orange),
                      _statItem('Alfa', selectedData['alpha'], Colors.red),
                    ],
                  ),
