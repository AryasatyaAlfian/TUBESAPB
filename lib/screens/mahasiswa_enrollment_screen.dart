...
class MahasiswaEnrollmentView extends StatefulWidget {
  ...
  @override
  State<MahasiswaEnrollmentView> createState() =>
      _MahasiswaEnrollmentViewState();
}
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: TabBarView(
            controller: _tab,
            children: [_availableList(isDark), _myEnrollments(isDark)],
          ),
        ),
      ],
    );
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'Ambil mata kuliah untuk memulai.',
              style: TextStyle(color: AppColors.neutral),
            ),
          ],
        ),
